...
class TestPlan:
    ...
    def run_testplan(self,http):
        ...
        if [] == testcases_for_testplan:
            ...
            return
        testcases_id_for_testplan = testcases_for_testplan.keys()#测试用例元组
        logger.info('成功获取测试计划[project=%s，name=%s]的测试用例id：%s' % (
        ...
        for testcase_id_str in testcases_id_for_testplan:
            ...
            data = (
            executed_history_id, testcase_id, str(testcase_name), testsuite_name, self.testplan_name, self.testproject,
            'Block', '')
            ...
            sql_update = 'UPDATE ' + testcase_report_tb + ' SET runresult=\"%s\", runtime=\"%s\"' \
                                                          ...
                                                          (testcase_run_result, run_time, executed_history_id,
                                                           testcase_id, self.testproject, self.testplan_name)
